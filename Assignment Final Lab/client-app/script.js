...
function addItem(item) {
    // 'item.link' contains the URL you want to link to
    let liElem = document.createElement("li");
    let aElem = document.createElement("a");
    aElem.href = item.link; // Set the href attribute to the link URL
    aElem.appendChild(document.createTextNode(item.title));
